...
CREATE TABLE IF NOT EXISTS projects (
  ...
  status TINYINT NOT NULL DEFAULT 1,
  latest_sync_at DATETIME NULL,
  latest_backfilled_candles INT NOT NULL DEFAULT 0,
  latest_sync_error TEXT NULL,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS positions (
  ...
  position_cost DECIMAL(18,8) NOT NULL DEFAULT 0,
  avg_cost_price DECIMAL(18,8) NOT NULL DEFAULT 0,
  realized_profit DECIMAL(18,8) NOT NULL DEFAULT 0,
